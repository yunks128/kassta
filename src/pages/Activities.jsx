      ...
      <section id="workshop2025">
        <div className="container">
          ...
          <div className="info-box" style={{ display: 'flex', gap: 28, alignItems: 'flex-start', flexWrap: 'wrap' }}>
            <img src={import.meta.env.BASE_URL + 'images/workshop-group.jpg'} alt="Workshop 2025 group photo" style={{ width: 260, maxHeight: 380, objectFit: 'cover', borderRadius: 8, flexShrink: 0 }} />
